...
def listar_posts():
    ...
    return render_template('posts/listarposts.html', posts=posts, categories=categories)
...
def add_post():
    if request.method == 'POST':
        ...
        return redirect(url_for('posts.listar_posts'))  # Asegúrate de que 'posts.index' esté definido en alguna parte
